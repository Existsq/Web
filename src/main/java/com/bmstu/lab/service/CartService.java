...
public class CartService {
  ...
  public void addCategoryToCalculateCpi(Long userId, Long categoryId, Category category) {
    ...
    boolean exists =
        categoryRepository.findByCalculateCpi(calculateCpi).stream()
  ...
  public CartSummaryDTO calculateCartSummary(Long userId) {
    ...
    List<CalculateCpiCategory> calculateCpiCategories = calculateCpi.getCalculateCpiCategories();
    ...
    List<Category> categories =
        cpiCalculator.mapToCategoriesWithCoefficient(calculateCpiCategories, totalSpent);
